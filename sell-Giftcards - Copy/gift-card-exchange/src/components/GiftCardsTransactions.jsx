...
const GiftCardTransactions = () => {
  ...
  const fetchGiftCardTransactions = async (userMapData = {}) => {
    try {
      setLoading(true);
      setError(null);
      ...
      const processTransaction = (tx, docId, userId = null) => {
        ...
        // Parse original amount and currency
  ...
  const fetchData = async () => {
    try {
      ...
      await fetchGiftCardTransactions(userData);
    } catch (error) {
    ...
    <div className="bg-[rgb(255,240,120)] min-h-screen flex">
      ...
      <div className="flex-1 p-4 md:p-8 md:pt-4 pt-24 overflow-auto">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
              ...
              <p className="text-black/60 mt-1 lg:mt-2 text-sm lg:text-base">
                {viewMode === 'brandDetail' && selectedBrand
                  ? `Detailed performance for ${selectedBrand} gift cards`
                  : 'Track all gift card sales and purchases'
                }
              </p>
            </div>
          ...
          {error && (
            <div className="mb-4 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
              ...
              <button
                onClick={fetchData}
                className="mt-2 text-sm text-red-400 hover:text-red-800"
              >
                Try Again
              </button>
            </div>
          ...
          {!loading && transactions.length === 0 && (
            <div className="mb-4 p-4 bg-yellow-400/10 border border-yellow-400/30 rounded-lg">
              ...
              <p className="text-black/70 text-xs mt-1">
                Check your Firebase console to verify data exists. Make sure transactions are being saved.
              </p>
            </div>
          )}
          ...
          {viewMode === 'overview' && (
            <div className="flex flex-col lg:flex-col gap-3 lg:gap-4 mb-6">
              <div className="flex-1 relative">
                ...
                <input
                  type="text"
                  placeholder="Search by brand, user, card code, or status..."
                  value={searchTerm}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <option value="usd">Sort by USD Value</option>
        ...
        {viewMode === 'brandDetail' && selectedBrandStats && (
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-black">{selectedBrand} Performance</h2>
                <p className="text-black/60">{selectedBrandStats.transactionCount} transactions • {formatUSD(selectedBrandStats.totalUsdEquivalent)} total volume</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-white/40 mt-1">
                      {selectedBrandStats.sales} sales
                    </p>
                  </div>
              ...
              <div className="bg-black rounded-xl p-6 border border-white/10">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white/40 text-sm font-medium">Avg Transaction</p>
                    <p className="text-2xl font-bold text-[rgb(255,240,120)] mt-2">
        ...
        {viewMode === 'overview' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-3 lg:gap-6 mb-6 lg:mb-8">
            {[
              ...
              {
                title: "Avg Rate",
                value: totalStats.totalUsdVolume > 0
                  ? `₦${(totalStats.totalNairaRevenue / totalStats.totalUsdVolume).toFixed(2)}/$`
                  : '₦0/$',
                subtext: "Average exchange rate",
                bgColor: "bg-white/10",
                textColor: "text-[rgb(255,240,120)]",
        ...
        {viewMode === 'overview' && brandStatsArray.length > 0 && (
          <div className="mb-6 lg:mb-8">
            <h3 className="text-lg font-semibold text-black mb-3 lg:mb-4">Brand Performance</h3>
                  ...
                  <div className="flex items-center justify-between mb-3 lg:mb-4">
                    <div className="flex items-center gap-2 lg:gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/40">{brand.transactionCount} transactions</p>
                      </div>
                    </div>
        ...
        <div className="bg-black rounded-xl border border-white/10 overflow-hidden">
          <div className="px-4 lg:px-6 py-3 lg:py-4 border-b border-white/10">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <h3 className="text-lg font-semibold text-[rgb(255,240,120)]">
                {viewMode === 'brandDetail' && selectedBrand
                  ? `${selectedBrand} Transactions (${brandDetailTransactions.length})`
                  : `All Gift Card Transactions (${sortedTransactions.length})`
                }
              </h3>
          ...
          {loading ? (
            <div className="py-8 lg:py-12 text-center">
              ...
              <p className="text-white/40 mt-3 lg:mt-4">Loading gift card transactions...</p>
            </div>
            ...
            <div className="py-8 lg:py-12 text-center">
              <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto">
                <BsGift className="w-6 h-6 lg:w-8 lg:h-8 text-white/40" />
              </div>
              <h3 className="text-lg font-medium text-white mt-3 lg:mt-4">No gift card transactions found</h3>
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className={`inline-block px-2 py-0.5 rounded-full text-xs mt-1 ${tx.type === 'purchase' ? 'bg-green-500/20 text-green-400' : 'bg-green-500/20 text-green-400'
                              }`}>
                              Sale
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <div className="font-semibold text-green-400">{formatUSD(tx.usdEquivalent)}</div>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className={`px-2 py-0.5 rounded-full text-xs font-semibold inline-block ${tx.status === 'Completed'
                        ...
                        {tx.rate > 0 && (
                          <div>
                            ...
                            <div className="text-[rgb(255,240,120)]">₦{tx.rate.toFixed(2)}/$</div>
                          </div>
                        )}
                        {tx.cardCost > 0 && (
                          <div>
                            <div className="text-white/40">Cost</div>
                            <div className="text-red-400">{formatCurrency(tx.cardCost)}</div>
                          </div>
                        )}
                  ...
                  <tbody className="divide-y divide-white/5">
                    {(viewMode === 'brandDetail' ? brandDetailTransactions : currentTransactions).map((tx) => (
                      ...
                      >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                ...
                                {tx.cardCode && (
                                  <div className="text-xs text-white/40 truncate max-w-[100px]">
                                    Code: {tx.cardCode.slice(0, 8)}...
                                  </div>
                                )}
                              </div>
                            </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${tx.type === 'purchase' ? 'bg-green-500/20 text-green-400' : 'bg-green-500/20 text-green-400'
                            }`}>
                            Sale
                          </span>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className={`px-3 py-1 rounded-full text-xs font-semibold ${tx.status === 'Completed'
                              ? 'bg-green-500/20 text-green-400'
                              : tx.status === 'Failed'
                                ? 'bg-red-500/20 text-red-400'
                                : 'bg-yellow-500/20 text-yellow-400'
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                            ...
                            className="text-[rgb(255,240,120)] hover:opacity-80 font-medium text-sm"
                          >
                            View Details →
                          </button>
                        </td>
